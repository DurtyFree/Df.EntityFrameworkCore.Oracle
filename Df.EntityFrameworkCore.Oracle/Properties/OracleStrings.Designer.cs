...
using Df.EntityFrameworkCore.Oracle.Diagnostics;
using Df.EntityFrameworkCore.Oracle.Utilities;
using Microsoft.EntityFrameworkCore.Diagnostics;
using Microsoft.Extensions.Logging;


namespace Df.EntityFrameworkCore.Oracle.Properties
{
    /// <summary>
    ...
    public static class OracleStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Df.EntityFrameworkCore.Oracle.Properties.OracleStrings", typeof(OracleStrings).GetTypeInfo().Assembly);
